...
- 正常固定作業（含工作摘要）：445（四週）／543（五週）
- 有 1～2 件決策案件的月份：490～633
...
| 方案 | 否決理由 |
|---|---|
| 副主席在群組輸入泛用指令觸發排程公告 Reply | 若只是為排程公告人工製造任意訊息，等同自己貼公告，多餘。2026-08-28 的案件開票與回饋是明確例外：副主席本來就要發布案件公版，該完整文案同時是對應圖卡的精準呼喚事件。 |
...
委員群封閉、自然活躍度不確定，因此月會提醒與工作摘要仍不依賴「等待任意群訊息」的機會性投遞，繼續使用獨立 OA 的 Push 額度。
