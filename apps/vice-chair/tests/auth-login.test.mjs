...
for(const endpoint of ["monthly-data","committee-meetings","analysis-draft","analysis-snapshots","ai-settings","ai-chat","new-member-registration","member-departure","company","test-data-reset","attendance","tasks","case-states","task-file"]){
