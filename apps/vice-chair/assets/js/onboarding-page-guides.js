(function(global){
  ...
  catalog.registerGuides({
    "page:partners":page({
      key:"partners",name:"夥伴名錄",version:"1.0.0",title:"依月份與欄位整理夥伴近況",
      ...
      steps:[
        ...
        s("search","篩選夥伴",".filter-grid","搜尋、專業別與到期篩選可以合用","搜尋姓名或專業別，再縮小到本月、未來 30／90 天、日期已過或缺到期日的夥伴。"),
        ...
        s("detail","個人資料",".table-scroll","點姓名看完整會籍與所選期間數據","個人詳情顯示所有活動欄位；右上角叉號或 Escape 可關閉。找不到結果時可清除篩選，手機可左右滑動表格。")
      ]
    }),
