(function(global){
  ...
  catalog.registerGuides({
    "page:renewal-foundations":page({
      key:"renewal-foundations",name:"續約地基追蹤",version:"1.1.0",
      ...
      steps:[
        ...
        s("summary","追蹤概況",".summary","資料待補不等於零人或未達成","來賓與培訓積分由正式 PALMS 核對；培訓採教育單位，不是紅綠燈換算分數。先確認資料涵蓋期間，缺資料時補資料；尚未起算也不算逾期。"),
