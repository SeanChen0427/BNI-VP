...
function save(){localStorage.setItem(KEY,JSON.stringify(serialize()));const d=new Date();$("#saveState").textContent="草稿已儲存";$("#saveTime").textContent=`最後儲存 ${d.toLocaleTimeString("zh-TW",{hour:"2-digit",minute:"2-digit"})}`;progress()}
